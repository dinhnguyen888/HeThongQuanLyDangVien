    ...
    public partial class FormXemChiTiet : Form
    {
        ...
        private void TaoControlsChoPanel(FlowLayoutPanel panel, List<PropertyInfo> properties, int controlWidth)
        {
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                // Set tất cả controls thành ReadOnly/Disabled
                ...
                else if (inputControl is RichTextBox richTextBox)
                {
                    ...
                    richTextBox.BackColor = Color.FromArgb(245, 245, 245);
                }
                else if (inputControl is Panel picturePanel)
                {
                    // Ẩn các button chọn/xóa ảnh
